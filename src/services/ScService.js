...
export default class ScService {
  ...
  static async topTracks (genre="pop") {
    ...
    const url = `https://test.cors.workers.dev/?${VBASE_URL}?kind=top&genre=soundcloud:genres:${genre}&client_id=${process.env.REACT_APP_SOUNDCLOUD_API_KEY}&limit=18&offset=1`;
    try {
